...
void bttn_interrupt(){
    flag0 = 1;   //flag varible set to 1 when he voltage falls to 0 volts 
...
int main (){
    ...
    ThisThread :: sleep_for(10ms);  //ensures button bounce does no cause the mbed to see two presses
    }
}
